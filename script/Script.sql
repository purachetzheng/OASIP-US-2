...
(1, 'Somchai Jaidee (OR-7)', 'somchai.jai@mail.kmutt.ac.th', 2, 30, '2022-05-23 13:30:00', null),
(2, 'Somsri Rakdee (SJ-3)', 'somsri.rak@mail.kmutt.ac.th', 1, 30, '2022-04-27 9:30:00', 'ขอปรึกษาปัญหาเพื่อนไม่ช่วยงาน'),
(3, 'สมเกียรติ ขยันเรียน กลุ่ม TT-4', 'Test3@3', 3, 15, '2022-01-01 16:30:00', null);
