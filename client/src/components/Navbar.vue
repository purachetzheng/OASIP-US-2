            ...
            <div class="">
                <div class="flex space-x-6 text-sm font-medium">
                    <button @click="goTo('Home')"
                        :class="[$route.name==='Home'?'text-cyan-600':'text-gray-100 hover:text-gray-900 hover:text-gray-300','inline-flex font-semibold']">
                    ...
                    <button @click="goTo('Schedules')"
                        :class="[$route.name==='Schedules'?'text-cyan-600':'text-gray-100 hover:text-gray-900 hover:text-gray-300','inline-flex font-semibold']">
                        <!-- <div class="rounded-full p-2 bg-gradient-to-r from-green-400 to-blue-700"></div> -->
